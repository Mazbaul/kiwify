...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/js/Component.vue?vue&type=template&id=04b31ccc&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('transition',{attrs:{"enter-active-class":_vm.transition.enter,"leave-active-class":_vm.transition.leave}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.isActive),expression:"isActive"}],staticClass:"toast",class:[("toast-" + _vm.type), ("is-" + _vm.position)],attrs:{"role":"alert"},on:{"mouseover":function($event){return _vm.toggleTimer(true)},"mouseleave":function($event){return _vm.toggleTimer(false)},"click":_vm.whenClicked}},[_c('div',{staticClass:"toast-icon"}),_vm._v(" "),_c('p',{staticClass:"toast-text",domProps:{"innerHTML":_vm._s(_vm.message)}})])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/js/Component.vue?vue&type=template&id=04b31ccc&
...
/* concated harmony reexport Positions */__webpack_require__.d(__webpack_exports__, "Positions", function() { return positions; });
